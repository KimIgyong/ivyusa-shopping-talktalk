...
-- 2026-08-07: customer-facing product catalog cache (PLN-260807-IvyusaApp-Revamp F1).
-- Synced from the tenant storefront's public /products.json; archived (never deleted)
-- when a complete sync no longer sees the handle. See sql/migration_products_cache.sql.
