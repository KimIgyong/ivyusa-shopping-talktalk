...
export class CampaignService {
  ...
  async listAll(page: number, size: number): Promise<[Campaign[], number]> {
  ...
  async create(input: CreateCampaignRequest): Promise<Campaign> {
  ...
  async update(id: number, input: UpdateCampaignRequest): Promise<Campaign> {
